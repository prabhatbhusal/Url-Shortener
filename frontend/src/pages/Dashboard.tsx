...
const Dashboard = () => {
    ...
    return (
        <section className="max-w-[1200px] mx-auto px-4 py-6 font-sans">
    ...
    <div className="flex flex-col lg:flex-row gap-8 items-start">
      ...
      <div className="w-full lg:flex-[1.3] bg-white border border-slate-200 rounded-xl p-6 flex flex-col justify-between min-h-[480px] shadow-sm">
        ...
        <div className="mt-4 border-t border-slate-100 pt-4 flex flex-col gap-3">
          ...
          {selectedAlias && (
            <button 
              onClick={() => fetchData(selectedAlias)}
              className="w-full py-3 bg-slate-700 hover:bg-slate-800 text-white font-bold text-sm rounded-lg shadow-sm transition-colors duration-200 flex items-center justify-center gap-2"
            >
              🔄 Refresh 
            </button>
          )}
